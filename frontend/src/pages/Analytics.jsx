...
export default function Analytics() {
  ...
  return (
    <AppLayout role="teacher">
      <header className="mb-xl flex items-start justify-between">
        <div>
        ...
        {/* Quiz selector */}
        <select
          className="border border-outline-variant rounded-xl px-md py-sm font-label-md text-label-md outline-none focus:border-primary bg-white"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-md mb-xl">
        {[
          ...
          <div key={stat.label} className="bg-white p-md rounded-2xl ambient-shadow card-hover">
            <div className={cn('w-10 h-10 rounded-xl flex items-center justify-center mb-sm', stat.iconBg, stat.iconColor)}>
              <span className="material-symbols-outlined">{stat.icon}</span>
            </div>
            <p className="font-label-md text-label-md text-secondary">{stat.label}</p>
            <p className="font-display-lg text-[32px] font-bold text-on-background mt-xs leading-none">{stat.value}</p>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-lg">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="bg-white rounded-2xl ambient-shadow p-md">
            ...
            <div className="flex items-center gap-4 mt-md pt-md border-t border-outline-variant">
